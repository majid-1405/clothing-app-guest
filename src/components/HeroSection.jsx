        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="flex flex-col justify-center items-center sm:max-w-lg">
            ...
            <p className="mt-4 text-xl text-gray-500  font-gothic">
              Temukan Pakaian yang Sesuai dengan Gaya Hidup Anda!
            </p>
            <br />
            <br />
            <button className="px-5 py-2 border border-black text-black font-semibold rounded-md hover:bg-black hover:text-white transition font-gothic">
              Shop Collection
            </button>
          </div>
          <div>
